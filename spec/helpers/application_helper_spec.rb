...
describe FatFreeCrm::ApplicationHelper do

  it "should be included in the object returned by #helper" do
    included_modules = (class << helper; self; end).send :included_modules
    included_modules.should include(FatFreeCrm::ApplicationHelper)
  end

  describe "link_to_emails" do
    it "should add Bcc: if dropbox address is set" do
      FatFreeCrm::Setting.stub!(:email_dropbox).and_return({ :address => "drop@example.com" })
    ...
    it "should not add Bcc: if dropbox address is not set" do
      FatFreeCrm::Setting.stub!(:email_dropbox).and_return({ :address => nil })
    ...
    it "should escape HTML entities" do
      FatFreeCrm::Setting.stub!(:email_dropbox).and_return({ :address => 'dr&op@example.com' })
