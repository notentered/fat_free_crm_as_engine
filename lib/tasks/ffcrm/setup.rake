...
namespace :ffcrm do
  ...
  namespace :setup do
    ...
    task :admin => :environment do
      ...
      FatFreeCRM.user_class.reset_column_information # Reload the class since we've added new fields in migrations.
      user = FatFreeCRM.user_class.find_by_username(username) || FatFreeCRM.user_class.new
